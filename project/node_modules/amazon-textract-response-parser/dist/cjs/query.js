...
exports.QueryInstanceCollectionGeneric = exports.QueryInstanceGeneric = exports.QueryResultGeneric = void 0;
const base_1 = require("./base");
const geometry_1 = require("./geometry");
class QueryResultGeneric extends base_1.PageHostedApiBlockWrapper {
    constructor(block, parentQuery) {
        super(block, parentQuery.parentPage);
        this._geometry = block.Geometry ? new geometry_1.Geometry(block.Geometry, this) : undefined;
...
exports.QueryResultGeneric = QueryResultGeneric;
class QueryInstanceGeneric extends base_1.PageHostedApiBlockWrapper {
    ...
    get topResult() {
        ...
        const top = (0, base_1.argMax)(results.map((r) => r.confidence));
        if (top.maxIndex < 0)
            return undefined;
    ...
    html() {
        ...
        return [
            '<div class="query">',
            (0, base_1.indent)(`<p>${(0, base_1.escapeHtml)(this.text)}</p>`),
            (0, base_1.indent)(resultsByConf.length ? ["<ul>", (0, base_1.indent)(resultsHtml), "</ul>"].join("\n") : "<ul></ul>"),
            "</div>",
        ].join("\n");
    }
    str() {
...
exports.QueryInstanceGeneric = QueryInstanceGeneric;
class QueryInstanceCollectionGeneric {
    ...
    html() {
        return ['<div class="queries">', (0, base_1.indent)(this._queries.map((q) => q.html()).join("\n")), "</div>"].join("\n");
    }
    iterQueries(opts = {}) {
        return (0, base_1.getIterable)(() => this.listQueries(opts));
    }
    listQueries(opts = {}) {
...
exports.QueryInstanceCollectionGeneric = QueryInstanceCollectionGeneric;
