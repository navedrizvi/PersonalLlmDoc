...
class FieldKeyGeneric extends (0, content_1.WithWords)(base_1.PageHostedApiBlockWrapper) {
    ...
    getOcrConfidence(aggMethod = "MEAN") {
        return (0, base_1.aggregate)(this.listWords().map((w) => w.confidence), aggMethod);
    }
    html() {
...
class FieldValueGeneric extends (0, content_1.buildWithContent)()(base_1.PageHostedApiBlockWrapper) {
...
class FieldGeneric {
    ...
    getOcrConfidence(aggMethod = "MEAN") {
        ...
        return (0, base_1.aggregate)(keyValContent.map((c) => c.confidence), aggMethod);
    }
    ...
    html() {
        var _a;
        return `<input label="${(0, base_1.escapeHtml)(this._key.text, {
            forAttr: true,
        })}" type="text" disabled value="${(0, base_1.escapeHtml)(((_a = this._value) === null || _a === void 0 ? void 0 : _a.text) || "", { forAttr: true })}" />`;
    }
    str() {
...
class FormGeneric {
    ...
    html() {
        return `<form>\n${(0, base_1.indent)(this.listFields()
            .map((f) => f.html())
            .join("\n"))}\n</form>`;
    }
