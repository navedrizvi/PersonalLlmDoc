...
exports.TableGeneric = exports.TableTitleGeneric = exports.TableFooterGeneric = exports.RowGeneric = exports.MergedCellGeneric = exports.CellGeneric = void 0;
const base_1 = require("./base");
const content_1 = require("./content");
const geometry_1 = require("./geometry");
class CellBaseGeneric extends base_1.PageHostedApiBlockWrapper {
...
function WithCellBaseProps(SuperClass) {
    return class extends SuperClass {
        ...
        getOcrConfidence(aggMethod = "MEAN") {
            return (0, base_1.aggregate)(this.listContent().map((c) => c.confidence), aggMethod);
        }
...
class CellGeneric extends WithCellBaseProps((0, content_1.buildWithContent)()(CellBaseGeneric)) {
    constructor(block, parentTable) {
...
class MergedCellGeneric extends WithCellBaseProps((0, content_1.buildWithContent)()(CellBaseGeneric)) {
    constructor(block, parentTable) {
        super(block, parentTable);
        this._geometry = new geometry_1.Geometry(block.Geometry, this);
    }
    ...
    iterSubCells() {
        return (0, base_1.getIterable)(() => this.listSubCells());
    }
}
...
class RowGeneric {
    ...
    getConfidence(aggMethod = "MEAN") {
        return (0, base_1.aggregate)(this._cells.map((c) => c.confidence), aggMethod);
    }
    getOcrConfidence(aggMethod = "MEAN") {
        const contentConfs = [].concat(...this._cells.map((cell) => cell.listContent().map((content) => content.confidence)));
        return (0, base_1.aggregate)(contentConfs, aggMethod);
    }
    iterCells() {
...
class TableFooterGeneric extends (0, content_1.WithWords)(base_1.PageHostedApiBlockWrapper) {
    get confidence() {
...
exports.TableFooterGeneric = TableFooterGeneric;
class TableTitleGeneric extends (0, content_1.WithWords)(base_1.PageHostedApiBlockWrapper) {
    get confidence() {
        return this._dict.Confidence;
    }
    html() {
...
exports.TableTitleGeneric = TableTitleGeneric;
class TableGeneric extends base_1.PageHostedApiBlockWrapper {
    ...
    iterFooters() {
        return (0, base_1.getIterable)(() => this.listFooters());
    }
    iterRows(opts = {}) {
        const getIterator = () => {
            let ixRow = 0;
    ...
    iterTitles() {
        return (0, base_1.getIterable)(() => this.listTitles());
    }
    listFooters() {
        ...
        if (titleTexts.length && footerTexts.length) {
            ...
            return [
                ...
                (0, base_1.indent)([
                    ...
                    (0, base_1.indent)(titleInnerHtml),
                    "</div>",
                    "<table>",
                    (0, base_1.indent)(rowHtmls.join("\n")),
                    "</table>",
                    '<div class="table-footer">',
                    (0, base_1.indent)(footerInnerHtml),
                    "</div>",
                ].join("\n")),
                "</div>",
            ].join("\n");
            ...
            const innerHtml = [
                ...
                (0, base_1.indent)(captionHtml),
                "</caption>",
            ]
                .concat(rowHtmls)
                .join("\n");
            return `<table>\n${(0, base_1.indent)(innerHtml)}\n</table>`;
        }
    }
    str() {
        return ("Table\n==========\n" +
