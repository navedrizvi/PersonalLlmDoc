import { isLayoutBlockType } from "./api-models/base";
import { ApiBlockWrapper, ApiObjectWrapper, getIterable, indent, modalAvg, } from "./base";
...
import { LayoutFigureGeneric, LayoutFooterGeneric, LayoutGeneric, LayoutHeaderGeneric, LayoutKeyValueGeneric, LayoutListGeneric, LayoutPageNumberGeneric, LayoutSectionHeaderGeneric, LayoutTableGeneric, LayoutTextGeneric, LayoutTitleGeneric, } from "./layout";
import { QueryInstanceCollectionGeneric, QueryInstanceGeneric, QueryResultGeneric } from "./query";
import { CellGeneric, MergedCellGeneric, RowGeneric, TableFooterGeneric, TableGeneric, TableTitleGeneric, } from "./table";
export { ApiBlockWrapper, } from "./base";
export { SelectionElement, Word } from "./content";
export var ReadingOrderLayoutMode;
...
})(ReadingOrderLayoutMode || (ReadingOrderLayoutMode = {}));
export class Page extends ApiBlockWrapper {
    constructor(pageBlock, blocks, parentDocument) {
        ...
        this._layout = new LayoutGeneric([], this);
        this._queries = new QueryInstanceCollectionGeneric([], this);
        this._parse(blocks);
    }
    _parse(blocks) {
        this._content = [];
        ...
        this._queries = new QueryInstanceCollectionGeneric(queryBlocks, this);
        this._layout = new LayoutGeneric(layoutBlocks, this);
    }
...
export class LayoutFigure extends LayoutFigureGeneric {
}
export class LayoutFooter extends LayoutFooterGeneric {
}
export class LayoutHeader extends LayoutHeaderGeneric {
}
export class LayoutKeyValue extends LayoutKeyValueGeneric {
}
export class LayoutPageNumber extends LayoutPageNumberGeneric {
}
export class LayoutSectionHeader extends LayoutSectionHeaderGeneric {
}
export class LayoutTable extends LayoutTableGeneric {
}
export class LayoutText extends LayoutTextGeneric {
}
export class LayoutTitle extends LayoutTitleGeneric {
}
export class LayoutList extends LayoutListGeneric {
}
export class Layout extends LayoutGeneric {
}
export class QueryInstance extends QueryInstanceGeneric {
}
export class QueryInstanceCollection extends QueryInstanceCollectionGeneric {
}
export class QueryResult extends QueryResultGeneric {
}
...
export class TableFooter extends TableFooterGeneric {
}
export class TableTitle extends TableTitleGeneric {
}
