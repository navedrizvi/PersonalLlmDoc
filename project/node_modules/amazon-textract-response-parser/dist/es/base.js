...
export function escapeHtml(str, { forAttr = false } = {}) {
...
export function indent(text, { character = "\t", count = 1, includeEmptyLines = false, skipFirstLine = false } = {}) {
...
export function aggregate(arr, aggMethod) {
...
export class PageHostedApiBlockWrapper extends ApiBlockWrapper {
