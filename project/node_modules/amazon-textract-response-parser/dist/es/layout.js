import { escapeHtml, getIterable, indent, PageHostedApiBlockWrapper, } from "./base";
import { buildWithContent } from "./content";
...
class LayoutLineContainerItem extends buildWithContent({ contentTypes: ["LINE"] })(LayoutItemBaseGeneric) {
    iterTextLines() {
...
export class LayoutFigureGeneric extends LayoutLineContainerItem {
    html() {
...
export class LayoutFooterGeneric extends LayoutLineContainerItem {
    html() {
...
export class LayoutHeaderGeneric extends LayoutLineContainerItem {
    html() {
...
export class LayoutKeyValueGeneric extends LayoutLineContainerItem {
...
export class LayoutPageNumberGeneric extends LayoutLineContainerItem {
    html() {
...
export class LayoutSectionHeaderGeneric extends LayoutLineContainerItem {
    html() {
        return `<h2>\n${indent(escapeHtml(this.text))}\n</h2>`;
    }
    str() {
...
export class LayoutTableGeneric extends LayoutLineContainerItem {
...
export class LayoutTextGeneric extends LayoutLineContainerItem {
    html() {
        return `<p>\n${indent(escapeHtml(this.text))}\n</p>`;
    }
    str() {
...
export class LayoutTitleGeneric extends LayoutLineContainerItem {
    html() {
        return `<h1>\n${indent(escapeHtml(this.text))}\n</h1>`;
    }
    str() {
...
export class LayoutListGeneric extends buildWithContent({ contentTypes: ["LAYOUT_TEXT"] })(LayoutItemBaseGeneric) {
    html() {
        return `<ul>\n${indent(this.listContent()
