import { ApiBlockWrapper, escapeHtml, PageHostedApiBlockWrapper, } from "./base";
...
export function buildWithContent({ contentTypes = ["SELECTION_ELEMENT", "SIGNATURE", "WORD"], strict = false, } = {}) {
...
export class LineGeneric extends WithWords(PageHostedApiBlockWrapper) {
...
export class Signature extends ApiBlockWrapper {
    constructor(block) {
        super(block);
        this._geometry = new Geometry(block.Geometry, this);
    }
